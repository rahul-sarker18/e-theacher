...
const ServCart = ({ data }) => {
  ...
  return (
    <div className="max-w-xs rounded-md shadow-md justify-center shadow-lg shadow-cyan-500/50 my-3 items-center 2xl:ml-10 lg:ml-10 xl:ml-10  dark:bg-gray-900 dark:text-gray-100">
      <img
        src={img}
        alt=""
